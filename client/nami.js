(function (global, factory) {
    ...
    let Model = function(data, output){
        ...
        [ 0.23137255,  0.41568627,  0.8       ,  0.05     * (cmax-cmin) + cmin ],
        [ 0.15294118,  0.1254902 ,  0.89411765,  0.051    * (cmax-cmin) + cmin ],
        [ 0.44313725,  0.72156863,  0.97647059,  0.1      * (cmax-cmin) + cmin ],
        [ 0.        ,  0.41568627,  0.06666667,  0.101    * (cmax-cmin) + cmin ],
        [ 0.        ,  0.81568627,  0.        ,  0.25     * (cmax-cmin) + cmin ],
        [ 0.5372549 ,  0.50980392,  0.        ,  0.251    * (cmax-cmin) + cmin ],
        [ 0.99607843,  0.89803922,  0.07843137,  0.5      * (cmax-cmin) + cmin ],
        [ 0.51372549,  0.31372549,  0.        ,  0.501    * (cmax-cmin) + cmin ],
        [ 0.88235294,  0.50196078,  0.0627451 ,  0.75     * (cmax-cmin) + cmin ],
        [ 0.62352941,  0.0745098 ,  0.        ,  0.751    * (cmax-cmin) + cmin ],
        [ 0.97647059,  0.10196078,  0.        ,  1.       * (cmax-cmin) + cmin ],
        [ 1.        ,  1.        ,  1.        ,  1.001    * (cmax-cmin) + cmin ],
        [ 1.        ,  0.25098039,  0.76862745,  2.25     * (cmax-cmin) + cmin ]];
